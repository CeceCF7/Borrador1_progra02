...
"background-color: rgb(255, 255, 255);")
        ...
        self.radar_frame = QtWidgets.QFrame(self.frame_3)
        self.radar_frame.setStyleSheet("background-color: rgb(30, 30, 30);")
        self.radar_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.radar_frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.radar_frame.setObjectName("radar_frame")
        self.distance_1 = QtWidgets.QLineEdit(self.radar_frame)
        self.distance_1.setGeometry(QtCore.QRect(70, 120, 141, 31))
        self.distance_1.setStyleSheet("QLineEdit{\n"
"border: 2px solid rgb(255, 255, 255);\n"
"border-radius:8px;\n"
"background-color: rgb(0,0,0);\n"
"font: 75 12pt \"Times New Roman\" color(255,255,255);\n"
"}")
        self.distance_1.setText("")
        self.distance_1.setObjectName("distance_1")
        self.label_5 = QtWidgets.QLabel(self.radar_frame)
        self.label_5.setGeometry(QtCore.QRect(10, 20, 231, 61))
        self.label_5.setStyleSheet("color: rgb(255, 255, 255);\n"
"font: 87 12pt \"Comic Sans MS\";")
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.radar_frame)
        self.label_6.setGeometry(QtCore.QRect(20, 100, 31, 61))
        self.label_6.setStyleSheet("color: rgb(255, 255, 255);\n"
"font: 87 12pt \"Comic Sans MS\";")
        self.label_6.setObjectName("label_6")
        self.label_7 = QtWidgets.QLabel(self.radar_frame)
        self.label_7.setGeometry(QtCore.QRect(20, 180, 31, 61))
        self.label_7.setStyleSheet("color: rgb(255, 255, 255);\n"
"font: 87 12pt \"Comic Sans MS\";")
        self.label_7.setObjectName("label_7")
        self.distance_2 = QtWidgets.QLineEdit(self.radar_frame)
        self.distance_2.setGeometry(QtCore.QRect(70, 200, 141, 31))
        self.distance_2.setStyleSheet("QLineEdit{\n"
"border: 2px solid rgb(255, 255, 255);\n"
"border-radius:8px;\n"
"background-color: rgb(0,0,0);\n"
"font: 75 12pt \"Times New Roman\" color(255,255,255);\n"
"}")
        self.distance_2.setText("")
        self.distance_2.setObjectName("distance_2")
        self.distance_total = QtWidgets.QLabel(self.radar_frame)
        self.distance_total.setGeometry(QtCore.QRect(310, 170, 101, 31))
        self.distance_total.setStyleSheet("QLabel{\n"
"font: 75 12pt \"Times New Roman\";\n"
"color: rgb(255, 255, 255)\n"
"}")
        self.distance_total.setObjectName("distance_total")
        self.free = QtWidgets.QPushButton(self.radar_frame)
        self.free.setGeometry(QtCore.QRect(240, 170, 41, 28))
        self.free.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("c:\\Users\\Jashua\\OneDrive\\Escritorio\\AVANCE1\\IMAGENES/flecha.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.free.setIcon(icon3)
        self.free.setIconSize(QtCore.QSize(30, 30))
        self.free.setObjectName("free")
        self.verticalLayout_3.addWidget(self.radar_frame)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "DISTANCIAS:"))
        self.label_6.setText(_translate("MainWindow", "X"))
        self.label_7.setText(_translate("MainWindow", "Y"))
        self.distance_total.setText(_translate("MainWindow", "0"))
